...
class OrderStatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_state" do
    assert_difference("OrderState.count") do
      post order_states_url, params: { order_state: { order_id: @order_state.order_id, state_id: @order_state.state_id } }
    end
  ...
  test "should update order_state" do
    patch order_state_url(@order_state), params: { order_state: { order_id: @order_state.order_id, state_id: @order_state.state_id } }
